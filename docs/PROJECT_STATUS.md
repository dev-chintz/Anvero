...
- Automated tests for core flows — done (456 of 457 backend, 98 frontend
  passing across the suite as of 2026-09-24; the one backend failure
  predates this session and is unrelated — see "Not yet verified")
